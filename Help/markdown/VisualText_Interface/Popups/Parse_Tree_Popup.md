...
![](../../../helps/VisualText_Interface/Popups/parse_tree_popup.gif)

The [Parse Tree Menu](../Main_Parse_Tree_Menu.md#Parse_Tree_Menu) on the Main Menu describes all of the items in this submenu.

![Toggle Node Variables](../../../helps/Toolbar_buttons/toggle_node_variables.gif)  Toggle Node Variables button
...
![](../../../helps/VisualText_Interface/Windows/parse_yellow.gif)
