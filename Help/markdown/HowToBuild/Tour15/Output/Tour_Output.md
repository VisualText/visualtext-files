...
![](../../../../helps/Tutorials/GO.gif) After running the corporate analyzer on the input text, you can now examine the output in either of two ways. One is to click on the "Output" button in the Debug Toolbar:

![](../../../../helps/HowToBuild/Tour15/Output/Image163.gif)

The second is to click the button next to the Output button and choose the "output" file from the available dump files:

![](../../../../helps/HowToBuild/Tour15/Output/Image164.gif)
...
![](../../../../helps/HowToBuild/Tour15/Output/Image165.gif)

**Next Section:** [Parse Tree ![](../../../../helps/HowToBuild/Tour15/Output/Bullet7.gif)](../ParseTrees/Tour_ParseTrees.md)
