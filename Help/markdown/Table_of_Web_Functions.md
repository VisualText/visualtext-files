...
| [**urltofile(url_str,file_str)**](urltofile.md) | **STR** | Fetch the web page specified by the url_str into a file located at file file_str on the local machine. **(New in 1.6)** |
|   |   |   |
