...
Find parent concept of current concept.

## Syntax

```
returnedConcept = up(currentConcept)
```
...
If currentConcept is a bad concept, a warning is written to output log.
...
[down](down.md), [prev](prev.md), [next](next.md), [Knowledge Base Functions](Table_of_Knowledge_Base_Functions.md)
