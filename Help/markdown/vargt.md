...
Succeeds (keeps the match) if the matched node has a variable called varName whose numeric value is greater than num; otherwise fails and the element does not match.
