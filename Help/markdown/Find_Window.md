...
![](../helps/VisualText_Interface/Windows/find_in_files_wtitles.gif)

Searches can be initiated by selecting** Find in Files **from the **Edit Menu** or by clicking on the **Find in Files** button ![](../helps/Toolbar_buttons/find_in_files_button.gif) on the **Main Toolbar**.
